  ...
  return (
    <div className="flex flex-col justify-between w-full min-h-[calc(100dvh-60px)] max-w-[1440px] mx-auto tenor relative overflow-hidden lg:pt-5">
      ...
      <section
        ...
        className="flex flex-col h-fit w-full lg:w-[calc(50%-4rem)] border-t-[1px] lg:border-[1px] border-[#888]/60 lg:p-[2rem] lg:ml-[50%]"
      >
        <div className="w-full h-fit px-[.5rem] sm:px-[1rem] lg:px-0 mx-auto text-[#fcfcfc] tenor">
          <div className="flex flex-col w-full">
            <div className="flex justify-between w-full mt-2 mb-3 pb-1 lg:mt-0 border-b-[1px] border-[#888]/40">
              <span className="text-sm lg:text-2xl">Sub Total</span>
              <span className="font-sans text-base flex items-center">
                ${cart.getTotalAmount()}
              </span>
            </div>
            <span className="text-sm lg:text-base text-[#fcfcfc]/60 mb-2">
